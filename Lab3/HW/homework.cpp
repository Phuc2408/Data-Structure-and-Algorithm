...
double closestPair(vector<Point2D> &points)
{
    ...
    sort(pointsX.begin(), pointsX.end(), [](const Point2D &a, const Point2D &b)
         { return a.x < b.x; });
    sort(pointsY.begin(), pointsY.end(), [](const Point2D &a, const Point2D &b)
         { return a.y < b.y; });

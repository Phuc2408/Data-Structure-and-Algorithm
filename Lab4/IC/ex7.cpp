...
// Wrapper function for mergeSort to use it with measureSortTime
void mergeSortWrapper(int arr[], int n) {
    mergeSort(arr, 0, n - 1);  // Calls mergeSort with left and right bounds
}
...
int main() {
    ...
    for (int i = 0; i < numSizes; i++) {
        ...
        // Reset the array and measure time for Merge Sort using the wrapper function
        copy(arr, arr + n, arrCopy);
